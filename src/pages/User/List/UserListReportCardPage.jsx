...
const UserListReportCardPage = () => {
  ...
  const { data: permission, loading: permissionLoading } =
    usePermissionFetcher("report card");
          ...
          <div className="flex mb-7 items-center justify-between gap-5">
            ...
            <div>
              ...
              {selectedTab === "templates" ? (
                <InteractiveButton
                  type={"button"}
                  onClick={() => navigate("/user/add-template")}
                >
...
export default UserListReportCardPage;
