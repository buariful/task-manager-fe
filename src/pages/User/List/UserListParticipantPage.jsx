...
const columns = [
  ...
  },
  {
    ...
    link: "/user/participant-reports", // the link will convert into /administrator/participant-reports/:id
...
const UserListParticipantPage = () => {
  ...
  const { data: permission, loading: permissionLoading } =
    usePermissionFetcher("participant");
  ...
  React.useEffect(() => {
    if (permission && permission.enable_disable === false) {
      const newColumns = tableColumns?.filter(
        (item) => item?.accessor !== "statusBoolean"
      );
      ...
      {permissionLoading ? (
        ...
        <PageWrapper>
          <ParticipantPageHeader
            ...
            isWithImport={permission?.import}
            isWithExport={permission?.export}
            isWithDelete={permission?.delete}
            isWithEnableDisable={permission?.enable_disable}
            isWithAdd={permission?.add}
          />
...
export default UserListParticipantPage;
