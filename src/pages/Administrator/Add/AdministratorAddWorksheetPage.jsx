...
export default function AdministratorAddWorksheetPage() {
  ...
  const handleCreateWorksheet = async (data) => {
    ...
    try {
      ...
      const { data: levelSkills } = await supabase
        ...
        .select("*, skill: skill_id(id, name, type, description)")
      ...
      console.log("reportCardHeader->>", reportCardHeader);
      console.log("worksheetPyalod->>", worksheetPyalod);
      ...
      if (participantError) {
        ...
        navigate("/administrator/worksheet");
      }
    } catch (error) {
