...
export default function AdministratorEditWorksheetPage() {
  ...
  * {
  ...
  .bg-accent { background-color: #21272A !important; }
  ...
  return isFetching ? (
    ...
    <PageWrapper>
      <EditWorksheetPageHeader
        ...
        editDetailsLink={`/administrator/edit-worksheet-details/${id}`}
        data={worksheet}
