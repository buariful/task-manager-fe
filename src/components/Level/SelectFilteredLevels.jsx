...
export default function SelectFilteredLevels({ visible, filters, setFilters }) {
  ...
  const handleLevelToggle = (e, value) => {
    const currentValues = filters.levelIds || [];
    const newValues = e.target.checked
      ? [...currentValues, value]
      : currentValues.filter((v) => v !== value);
    setFilters((prev) => ({ ...prev, levelIds: newValues }));
  };
          ...
          {loading ? (
            ...
            levels?.map((option) => (
              ...
              >
                <input
                  type="checkbox"
                  checked={filters?.levelIds?.includes(option.value) || false}
