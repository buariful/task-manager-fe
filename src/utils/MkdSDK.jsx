...
export default function MkdSDK() {
  this._baseurl = "https://api.parallel2software.com";
  // this._baseurl = "https://staci_j.mkdlabs.com";
  this._project_id = "staci_j";
  this._secret = "wuvkwperovo4vardxgq4gy3m4yl9l2lct";
  this._table = "";
  // this._mail_from = "info@mkdlabs.com";
  // this._mail_from = "admin@manaknightdigital.com";
  this._mail_from = "support@parallel2software.com";
  this._GOOGLE_CAPTCHA_SITEKEY = "6LfmBc8jAAAAAKfz4zIiX1HoAwuH-9kcx68-7hhd";

  const raw = this._project_id + ":" + this._secret;
  let base64Encode = btoa(raw);

  this.login = async function (email, password, role, remember_me = false) {
  ...
  this.sendMail = async function (payload) {
    // const result = await fetch(this._baseurl + "/v3/api/custom/riddlequiz/mail/send", {
  ...
  this.exportCSV = async function (name = "") {
    const header = {
      "content-type": "application/json",
      "x-project": base64Encode,
      Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    hiddenElement.download = name ? `${name}.csv` : this._table + ".csv";
    hiddenElement.click();
  ...
  this.importCSV = async function (file) {
    const header = {
      "content-type": "application/json",
      "x-project": base64Encode,
      Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    const getResult = await fetch(
      this._baseurl + `/v1/api/rest/${this._table}/IMPORT`,
      {
        method: "post",
        headers: header,
        body: file,
  ...
  this.uploadPDF = async function (file) {
    const result = await fetch(this._baseurl + `/v2/api/lambda/s3/upload`, {
      method: "post",
      headers: {
        "x-project": base64Encode,
  ...
  // CUSTOM API
  this.getOfficialDashboardInfo = async function () {
    const result = await fetch(
      this._baseurl + "/v3/api/custom/staci_j/dashboard",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  this.createPrecinctsUploadingXlFile = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/precincts/IMPORT`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.uploadPrecincts = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/precincts/admin/IMPORT`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.readPdfData = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/pdf/read/ai`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.getAllUsersCustom = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/user/profile/join`,
      // "http://localhost:3048/v3/api/custom/staci_j/user/profile/join",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  this.convertPdfData = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/pdf/convert/ai`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.submitPublicPetition = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/petition/submit`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.sendBallot = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/election/send/ballot`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.sendBallotSeparately = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/ballot/send`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.getCandidates = async function (payload) {
    const result = await fetch(
      // this._baseurl + `/v3/api/custom/staci_j/user/profile/modification/join`,
      this._baseurl + `/v3/api/custom/staci_j/petition/modification/join`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.getCountyStatePetitions = async function (payload) {
    const result = await fetch(
      // this._baseurl + `/v3/api/custom/staci_j/user/profile/modification/join`,
      this._baseurl + `/v3/api/custom/staci_j/petition/state/county/join`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.deleteByFilter = async function (table, payload) {
    const result = await fetch(this._baseurl + `/v4/api/records/${table}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "x-project": base64Encode,
  ...
  this.getActiveElection = async function (state, type, county) {
    const result = await fetch(
      this._baseurl +
        `/v3/api/custom/staci_j/election/active/get?state=${state}&election_type=${type}${
  ...
  this.getParties = async function (state, type, county) {
    const result = await fetch(
      this._baseurl +
        `/v3/api/custom/staci_j/parties/get?state=${state}&election_type=${type}${
          county ? `&county=${county}` : ""
        }`,
      {
        method: "get",
  ...
  this.checkPetitionEmail = async function (email) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/email/check?email=${email}`,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  this.getRacesOfElection = async function (id) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/races/election/${id}`,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  this.getStateCountyRacesOfEl = async function (id) {
    const result = await fetch(
      this._baseurl +
        `/v3/api/custom/staci_j/state-county-races/election/${id}`,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  this.checkRaceName = async function (name, election_id) {
    const result = await fetch(
      this._baseurl +
        `/v3/api/custom/staci_j/races/check?name=${name}&election_id=${election_id}`,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  this.uploadFilePublic = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/s3/upload`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.uploadBallotPdf_crop = async function (file) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/pdf/crop_pdf_file`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.generatePdf = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/ballot/generate`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.tempLinkGenerate = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/temporary/link_genarete`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.getRacesPaginate = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/races/get`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.getModificationRequests = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/modification/retrieve`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
  ...
  this.createElection = async function (payload) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/election/create`,
      // `http://localhost:3048/v3/api/custom/staci_j/election/create`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
    ...
    if ([400, 401, 402, 403, 404, 500, 502, 501].includes(result.status)) {
      throw new Error(json.message);
    }
    return json;
  };

  this.getElectionList = async function (state, county) {
    const result = await fetch(
      this._baseurl +
        `/v3/api/custom/staci_j/election/official/get?state=${state}&county=${county}`,
      // `http://localhost:3048/v3/api/custom/staci_j/election/create`,
      {
        method: "get",
        headers: {
  ...
  // this.ballotTrackingUpdate2 = async function (trackingId) {
  //   const result = await fetch(
  //     this._baseurl +
  //       `/v3/api/public/staci_j/ballot_tracking/update/${trackingId}`,
  //     {
  //       method: "put",
  //       headers: {
  //         "x-project": base64Encode,
  ...
  this.ballotTrackingUpdate = async function (electionId, userId) {
    const result = await fetch(
      this._baseurl + `/v3/api/public/staci_j/ballot_tracking/update`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
        ...
        body: JSON.stringify({ election_id: electionId, user_id: userId }),
      }
    );
  ...
  this.checkPdfPassword = async function (pdfPassword, pdf_url) {
    const result = await fetch(
      this._baseurl + `/v3/api/custom/staci_j/pdf/validate-password`,
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
        ...
        body: JSON.stringify({ pdfPassword, pdf_url }),
      }
    );
  ...
  this.createRacesBulk = async function (formData) {
    const result = await fetch(
      this._baseurl + "/v3/api/custom/staci_j/races/upload/excel",
      {
        method: "post",
        headers: {
          "x-project": base64Encode,
