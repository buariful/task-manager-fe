export default function EcomSDK() {
  ...
  this.getFilteredProducts = async function (payload = {}) {
    ...
    payload.hasOwnProperty("price")
      ? (url = `${url}&price=${payload.price}`)
      : null;
    payload.hasOwnProperty("category")
      ? (url = `${url}&category_id=${payload.category}`)
      : null;
    payload.hasOwnProperty("is_featured")
      ? (url = `${url}&is_featured=${payload.is_featured}`)
      : null;
    payload.hasOwnProperty("name")
      ? (url = `${url}&name=${payload.name}`)
      : null;
    payload.hasOwnProperty("page")
      ? (url = `${url}&page=${payload.page}`)
      : null;
    payload.hasOwnProperty("limit")
      ? (url = `${url}&limit=${payload.limit}`)
      : `${url}&limit=${16}`;
    payload.hasOwnProperty("direction")
      ? (url = `${url}&direction=${payload.direction}`)
      : `${url}&direction=ASC`;
    payload.hasOwnProperty("order")
      ? (url = `${url}&orderBy=${payload.order}`)
      : `${url}&orderBy=id`;

    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/filters/?" + url,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.getFilteredProductsByCategory = async function (category_id) {
    const result = await fetch(
      this._baseurl +
        `/v2/api/lambda/ecom/filters/?type=category&id=${category_id}`,
      {
        method: "get",
        headers: this.getHeader(),
        // body: JSON.stringify(payload),
  ...
  this.getSingleProduct = async function (id) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/" + id,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.getStates = async function (country = 0) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/state/" + country,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.getCities = async function (state = 0) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/city/" + state,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.getReviews = async function (payload) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/review",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
  ...
  this.getUserReviews = async function (userId) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/user-review/" + userId,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.addReview = async function (payload) {
    ...
    payload.status = 1;
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/review/add",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
  ...
  this.getCart = async function () {
    let params = localStorage.hasOwnProperty("user")
      ? `user_id=${localStorage.getItem("user")}`
      : `session_id=${localStorage.getItem("cart-session")}`;
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/cart?" + params,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.addCartItem = async function (productId, quantity) {
    ...
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/cart/item",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
  ...
  this.updateCart = async function (data) {
    ...
    payload.data = data;
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/cart/update",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
  ...
  this.createCheckout = async function (data) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/create-checkout",
      {
        method: "post",
        headers: this.getHeader(),
  ...
  this.getShippingRates = async function () {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/shipping-rates",
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.applyCoupon = async function (coupon) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/coupon/apply",
      {
        method: "post",
        headers: this.getHeader(),
  ...
  this.getOrderItems = async function (checkoutId) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/order-item/" + checkoutId,
      {
        method: "get",
        headers: this.getHeader(),
      }
  ...
  this.verifyPayment = async function (paymentIntent) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/checkout-success",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify({
  ...
  this.getOrders = async function (payload) {
    ...
    payload.sortId = "id";
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/order-history/user",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
  ...
  this.addProduct = async function (payload) {
    const result = await fetch(
      this._baseurl + "/v2/api/lambda/ecom/product/add",
      {
        method: "post",
        headers: this.getHeader(),
        body: JSON.stringify(payload),
